...
class Estadisticas extends Component {
  ...
  usuariosRequest = async () => {
    ...
    var resultado = await axios.get(url + `/api/salas/fecha/${this.state.fechaInicio}/${this.state.fechaFin}`);
  ...
  salasRequest = async () => {
    var resultado = await axios.get(url + `/api/salas/salas/${this.state.fechaInicio}/${this.state.fechaFin}`);
